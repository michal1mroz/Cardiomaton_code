...
class UiMainWindow(object):
    ...
    @staticmethod
    def generate_minimal_ui(main_window: QMainWindow) -> None:
        """
        Generate a minimal version of the UI for showing before backend is loaded.
        Displays only background, logo, and title label.
        """
        # Window setup
        main_window.resize(1100, 600)
        main_window.setMinimumSize(QtCore.QSize(1100, 600))
        ...
        main_window.setWindowTitle("Cardiomaton (loading...)")
        ...
        # Logo (circle)
        logo = QtWidgets.QWidget(centralwidget)
        logo.setMinimumSize(QtCore.QSize(50, 50))
        logo.setMaximumSize(QtCore.QSize(50, 50))
        logo.setStyleSheet("""
            border-radius: 25px;
            background-color: #6D98F4;
            color: white;
        ...
        # Title label
        title_label = QtWidgets.QLabel("Cardiomaton", centralwidget)
        font = QtGui.QFont("Mulish ExtraBold", 22)
        title_label.setFont(font)
        title_label.setStyleSheet("color: #233348;")
