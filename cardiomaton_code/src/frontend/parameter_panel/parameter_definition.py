...
CELL_PARAMETER_DEFINITIONS: Final[Dict[str, Dict[str, ParameterDefinition]]] = {
    "PACEMAKER": {
        ...
        "t40":      ParameterDefinition(default=0.100, minimum=0.050,  maximum=0.400),
        "t03":      ParameterDefinition(default=0.010, minimum=0.002,  maximum=0.020),
        "t34":      ParameterDefinition(default=0.200, minimum=0.050,  maximum=0.300),
    },
    "ATRIAL": {
        ...
        "t01":    ParameterDefinition(default=0.004, minimum=0.0028, maximum=0.0052),
        "t12":    ParameterDefinition(default=0.008, minimum=0.0056, maximum=0.0104),
        "t23":    ParameterDefinition(default=0.158, minimum=0.110,  maximum=0.205),
        "t34":    ParameterDefinition(default=0.238, minimum=0.167,  maximum=0.309),
    ...
    "PURKINJE": {
        ...
        "t01":    ParameterDefinition(default=0.002, minimum=0.0014, maximum=0.0026),
        "t12":    ParameterDefinition(default=0.007, minimum=0.0049, maximum=0.0091),
        "t23":    ParameterDefinition(default=0.207, minimum=0.145,  maximum=0.269),
        "t34":    ParameterDefinition(default=0.307, minimum=0.215,  maximum=0.399),
        "t40":    ParameterDefinition(default=0.507, minimum=0.355,  maximum=0.659),
    },
}
